  ...
  return (
    <>
      <Navbar expanded={expand} fixed="top" expand="md" className={(navColour ? 'sticky' : 'navbar') + ' Navbar'}>
        <Container>
          <Navbar.Brand href="/#">{/* <img src={logo} className="logo" alt="brand" /> */}</Navbar.Brand>
          <Navbar.Toggle
                  ...
                  title={
                    user ? (
                      <Tooltip title={user.username}>
                        <Avatar sx={{height: '32px', width: '32px'}} alt={user.username} src={user.avatar} />
                      </Tooltip>
                    ) : (
                      <AccountCircleIcon />
                    )
                ...
                >
                  ...
                  {!isLoggedIn ? (
                    <NavDropdown.Item
                      ...
                      href={
                        process.env.REACT_APP_OAUTH_URL + '/register?serviceURL=' + process.env.REACT_APP_SERVICE_HOST
                      }
                    >
                      Register
                    </NavDropdown.Item>
                  ...
                  {isLoggedIn ? (
                    <NavDropdown.Item
                      onClick={onLogout}
                      href={
                        process.env.REACT_APP_OAUTH_URL + '/logout?serviceURL=' + process.env.REACT_APP_SERVICE_HOST
                      }
                    >
                      Logout
                    </NavDropdown.Item>
