...
const EditPost = (prop) => {
  ...
  const customEntityTransform = (entity, text) => {
    ...
    if (alignment && alignment.length) {
      return "<div style=\"text-align:".concat(alignment, ";\"><img src=\"").concat(entity.data.src, "\" alt=\"").concat(entity.data.alt, "\" height=\"").concat(entity.data.height, "\" width=\"").concat(entity.data.width, "\" style=\"height: ").concat(entity.data.height, ";width: ").concat(entity.data.width, "\"/></div>");
    }

    return "<img src=\"".concat(entity.data.src, "\" alt=\"").concat(entity.data.alt, "\" height=\"").concat(entity.data.height, "\" width=\"").concat(entity.data.width, "\" style=\"height: ").concat(entity.data.height, ";width: ").concat(entity.data.width, "\"/>");
  ...
  return (
    <section className="EditPost">
      ...
      <form>
        ...
        {form.category === Category.Announcement ?<Row>
            <ImageUpload
