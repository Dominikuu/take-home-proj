...
const CreatePost = (prop) => {
  ...
  const {title, category, tags, content, hidden, closed, is_pinned} = form;
    ...
    <section className="CreatePost">
      <Container>
        ...
        <form>
          ...
          <Row>
            <Swtich value={is_pinned} name="Pinned" formControlName="is_pinned" onChange={onInputChange}></Swtich>
          </Row>
          {authState.user && authState.user.role === Role.Admin ? (
            <>
              <Row>
                <Swtich value={closed} name="Stop comment" formControlName="closed" onChange={onInputChange}></Swtich>
              </Row>
              <Row>
                <Swtich value={hidden} name="Hide" formControlName="hidden" onChange={onInputChange}></Swtich>
              </Row>
            </>
          ) : null}
          <Row>
